...
#define SWIGTYPE_p_Polynomial swig_types[0]
...
/*-----------------------------------------------
              @(target):= _class_cpp_demo.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__class_cpp_demo

#else
#  define SWIG_init    init_class_cpp_demo

#endif
#define SWIG_name    "_class_cpp_demo"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_new_Polynomial(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
...
SWIGINTERN PyObject *_wrap_Polynomial_eval(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:Polynomial_eval",&obj0,&obj1)) SWIG_fail;
