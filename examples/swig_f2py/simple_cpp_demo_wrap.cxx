...
/*-----------------------------------------------
              @(target):= _simple_cpp_demo.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__simple_cpp_demo

#else
#  define SWIG_init    init_simple_cpp_demo

#endif
#define SWIG_name    "_simple_cpp_demo"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_bigger(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:bigger",&obj0,&obj1)) SWIG_fail;
  ecode1 = SWIG_AsVal_double(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "bigger" "', argument " "1"" of type '" "double""'");
  } 
  arg1 = static_cast< double >(val1);
  ecode2 = SWIG_AsVal_double(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "bigger" "', argument " "2"" of type '" "double""'");
  } 
  arg2 = static_cast< double >(val2);
  result = (double)bigger(arg1,arg2);
...
SWIGINTERN PyObject *_wrap_range(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:range",&obj0,&obj1)) SWIG_fail;
  {
    npy_intp dims[1];
    if (!PyInt_Check(obj0))
    {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"bigger", _wrap_bigger, METH_VARARGS, NULL},
