...
\lstinputlisting[language=C++]{../omp/adder_race.cc}
...
\lstinputlisting[language=C++]{../omp/adder_slow.cc}
...
\lstinputlisting[language=Python]{../mpi/hello.py}
...
\lstinputlisting[language=Python]{../mpi/p2p.py}
...
\lstinputlisting[language=Python]{../mpi/adder.py}
...
\lstinputlisting[language=Python]{../mpi/collective.py}
